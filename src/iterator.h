...
namespace tag {
	struct OverTwoVerticesOfSeg;  static const OverTwoVerticesOfSeg over_two_vertices_of_seg;
}
...
{	public :
	...
	CellIterator::Core * core;  // use unique pointer !!

	inline CellIterator ( const CellIterator & it );
	inline CellIterator ( CellIterator && it );

	inline CellIterator ( const tag::OverTwoVerticesOfSeg &, Cell::Positive::Segment * );
...
class CellIterator::Over::TwoVerticesOfSeg::NormalOrder : public CellIterator::Core
...
class CellIterator::Over::TwoVerticesOfSeg::ReverseOrder : public CellIterator::Core
...
( const tag::OverTwoVerticesOfSeg &, Cell::Positive::Segment * seg )
// we iterate over the two vertices, first base (negative) then tip (positive)
:	core { new CellIterator::Over::TwoVerticesOfSeg::NormalOrder ( seg ) }
{ }
...
{	public :
	...
	CellIterator::Core * base;  // use unique_ptr !!

	inline ForcePositive ( CellIterator::Core * b )
