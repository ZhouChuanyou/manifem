...
exe-3.20: iterator.o field.o function.o global.o main-3.20.o manifold.o mesh.o progressive.o
	g++ -o $@ -std=c++17 $^

exe-3.22: iterator.o field.o function.o global.o main-3.22.o manifold.o mesh.o progressive.o
	g++ -o $@ -std=c++17 $^
