...
{	Manifold RR3 ( tag::Euclid, tag::of_dim, 3 );
	...
	int n = 15;
	Mesh EN  ( tag::segment, E,  N, tag::divided_in, n );
	Mesh NW  ( tag::segment, N,  W, tag::divided_in, n );
	Mesh WS  ( tag::segment, W,  S, tag::divided_in, n );
	Mesh SE  ( tag::segment, S,  E, tag::divided_in, n );
	Mesh upE ( tag::segment, up, E, tag::divided_in, n );
	Mesh upN ( tag::segment, up, N, tag::divided_in, n );
	Mesh upW ( tag::segment, up, W, tag::divided_in, n );
	Mesh upS ( tag::segment, up, S, tag::divided_in, n );
